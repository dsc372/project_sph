      ...
      <div class="checkout-steps">
        ...
        <div class="step-cont">
          <ul class="payType">
            ...
            <li class="checked"><img src="./images/pay3.jpg" /></li>
          </ul>
        </div>
        <div class="hr"></div>
...
export default {
  ...
  computed: {
    ...
    ...mapState("order", ["payInfo"]),
  },
  methods: {
    async getPayInfo() {
      try {
        await this.$store.dispatch("order/getPayInfo", this.orderId);
      } catch (error) {
        alert(error);
      }
    },
    ...
    //element-ui中Message弹窗
    async open() {
      //生成二维码
      try {
        let url = await this.generateQR(this.payInfo.codeUrl);
